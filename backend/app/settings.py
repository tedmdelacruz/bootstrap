...
SECRET_KEY = config('DJANGO_SECRET_KEY', default='django-insecure-a9i2c0ln2%u)b4!e1ytjzzk+2yng8g#jkku6kr4fk1z2e(a1p@')
...
DATABASES = {
    'default': dj_database_url.parse(config('DATABASE_URL', default='postgres://app_user:your-db-password@db:5432/app_db'))
}
